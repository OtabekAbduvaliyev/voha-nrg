...
<div className='bgHeader bg-cover bg-center h-screen flex flex-col justify-end'>
  ...
  <header className="max-w-[1200px] mx-auto flex justify-between items-end w-full ">
    <div className="infor flex justify-center flex-col items-center justitems-center lg:flex-row justify-end px-[20px] lg:px-[0px] gap-[-60px] lg:mb-[-100px]">
      <h1 className="text-[80px] font-montserrat font-light lg:text-[120px] text-white leading-[110px] lg:text-[100px] text-center lg:text-start headerHdFont">
        NRG <br className='hidden lg:block'/> VOHA
      </h1>
      <h2 className="font-DancingScript lg:text-[110px] text-[#DFC59A] lg:ml-[-30px]  text-[80px] text-center lg:text-start lg:mt-[110px] marianna">
        Premium class
      </h2>
    </div>
