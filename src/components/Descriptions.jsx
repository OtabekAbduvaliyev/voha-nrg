...
const Descriptions = () => {
  ...
  return (
    <div>
      ...
      <div className="secondesc flex items-center max-w-[1280px] mr-auto justify-between px-[10px] lg:px-[0px] flex-wrap md:flex-nowrap mt-[100px]">
        <div className="imgdesc">
      ...
      <div className="fromPart text-center mt-[200px] max-w-[850px] m-auto px-[20px] pb-[100px]">
