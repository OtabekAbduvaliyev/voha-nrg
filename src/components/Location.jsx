...
const Location = () => {
    return (
        <>
        <div className='flex items-center gap-[180px] text-center justify-center lg:text-start xl:justify-start flex-wrap xl:flex-nowrap pb-[100px]'>
        <div className="map">
            ...
            <div className="locationInf">
                ...
                <p className='text-[18px] text-[#494949] font-Inter pt-[34px]'>Престижный Мирзо-Улугбекский район, <br /> ниже улица "Циолковского". <br />
